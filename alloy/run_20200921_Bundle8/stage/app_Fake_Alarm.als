...
one sig app_Fake_Alarm extends IoTApp {
...
one sig r0_trig0 extends r0_trig {} {
  capabilities = app_Fake_Alarm.smoke
...
one sig r0_comm0 extends r0_comm {} {
  capability   = app_Fake_Alarm.alarm
...
one sig r1_trig0 extends r1_trig {} {
  capabilities = app_Fake_Alarm.alarm
  attribute    = cap_alarm_attr_alarm
  no value
}
...
one sig r1_comm0 extends r1_comm {} {
  capability   = app_Fake_Alarm.state
