...
assert P__0 {
  ...
  no r : IoTApp.rules, action : r.commands {
    ...
    // e.g. check that all events on the paths e.g. is an event that is not NIGHT mode, and is not preceded by NIGHT mode
        ...
        {
            action'.attribute = cap_switch_attr_switch
            (no action'.value and cond.attribute = action'.attribute and cond.value = cap_switch_attr_switch_val_on
) or action'.value     = cap_switch_attr_switch_val_on
...
// P__0:^,cap_switch_attr_switch,cap_switch_attr_switch_val_on

// P__0:^,cap_switch_attr_switch,cap_switch_attr_switch_val_on

// P__0:^,cap_location_attr_mode,null
...
assert P__1 {
  ...
  no r : IoTApp.rules, action : r.commands {
    ...
    // e.g. check that all events on the paths e.g. is an event that is not NIGHT mode, and is not preceded by NIGHT mode
        ...
        {
            action'.attribute = cap_switch_attr_switch
            (no action'.value and cond.attribute = action'.attribute and cond.value = cap_switch_attr_switch_val_off
) or action'.value     = cap_switch_attr_switch_val_off
...
// P__1:^,cap_switch_attr_switch,cap_switch_attr_switch_val_off

// P__1:^,cap_switch_attr_switch,cap_switch_attr_switch_val_off

// P__1:^,cap_location_attr_mode,null
...
// P__2:^,cap_switch_attr_switch,cap_switch_attr_switch_val_on

// P__2:^,cap_switch_attr_switch,cap_switch_attr_switch_val_on

// P__2:^,cap_location_attr_mode,null
...
// P__3:^,cap_switch_attr_switch,cap_switch_attr_switch_val_off

// P__3:^,cap_switch_attr_switch,cap_switch_attr_switch_val_off

// P__3:^,cap_location_attr_mode,null
...
// P__4:^,cap_switch_attr_switch,cap_switch_attr_switch_val_on

// P__4:^,cap_switch_attr_switch,cap_switch_attr_switch_val_off
...
// P__5:^,cap_switch_attr_switch,cap_switch_attr_switch_val_on

// P__5:^,cap_switch_attr_switch,cap_switch_attr_switch_val_off
