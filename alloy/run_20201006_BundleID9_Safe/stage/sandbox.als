...
open app_DoorKnocker
open app_ID9DisableVacationMode_Safe
open app_BonVoyage
...
assert P__0 {
  ...
  no r : IoTApp.rules, action : r.commands {
    ...
    action.value     = app_ID9DisableVacationMode_Safe.newMode
...
check P__0
// P__0:cap_location_attr_mode,app_ID9DisableVacationMode_Safe.newMode,cap_presenceSensor_attr_presence,null
// P__0_insert_metadata_here

assert P__1 {
  // there is no situation where C occurs (e.g. the switch is automatically off)
  no r : IoTApp.rules, action : r.commands {
    action.attribute = cap_state_attr_vacation
    action.value     = cap_state_attr_vacation_val_false
    (some predecessor : r.*(~connected), action' : predecessor.triggers, cond: predecessor.conditions {
    // caused by some path of events
    // that does not have X (e.g. NIGHT mode)
    // e.g. check that all events on the paths e.g. is an event that is not NIGHT mode, and is not preceded by NIGHT mode
...
check P__1
// P__1:cap_state_attr_vacation,cap_state_attr_vacation_val_false,cap_switch_attr_switch,null
// P__1:^,cap_presenceSensor_attr_presence,null
// P__1:^,cap_presenceSensor_attr_presence,null
...
check P__2
// P__2:cap_state_attr_home,cap_state_attr_home_val_true,cap_location_attr_mode,null
// P__2:^,cap_presenceSensor_attr_presence,null
// P__2:^,cap_presenceSensor_attr_presence,null
...
check P__3
// P__3:cap_switch_attr_switch,cap_switch_attr_switch_val_off,cap_location_attr_mode,null
// P__3:^,cap_presenceSensor_attr_presence,null
// P__3:^,cap_presenceSensor_attr_presence,null
...
check P__4
// P__4:cap_switch_attr_switch,cap_switch_attr_switch_val_on,cap_location_attr_mode,null
// P__4:^,cap_presenceSensor_attr_presence,null
// P__4:^,cap_presenceSensor_attr_presence,null
...
assert P__5 {
  ...
  no r : IoTApp.rules, action : r.commands {
    action.attribute = cap_state_attr_vacation
    action.value     = cap_state_attr_vacation_val_true
    (some predecessor : r.*(~connected), action' : predecessor.triggers, cond: predecessor.conditions {
    // caused by some path of events
    // that does not have X (e.g. NIGHT mode)
    // e.g. check that all events on the paths e.g. is an event that is not NIGHT mode, and is not preceded by NIGHT mode
...
check P__5
// P__5:cap_state_attr_vacation,cap_state_attr_vacation_val_true,cap_switch_attr_switch,null
// P__5:^,cap_presenceSensor_attr_presence,null
// P__5:^,cap_presenceSensor_attr_presence,null
...
assert P__6 {
  ...
  no r : IoTApp.rules, action : r.commands {
    ...
    // e.g. check that all events on the paths e.g. is an event that is not NIGHT mode, and is not preceded by NIGHT mode
        ...
        // P__6_insert_more_here
        }
    }) 
  }
}
check P__6
// P__6:cap_location_attr_mode,cap_location_attr_mode_val_Home,cap_presenceSensor_attr_presence,null
// P__6_insert_metadata_here
...
assert P__7 {
  ...
  no r : IoTApp.rules, action : r.commands {
    ...
    // e.g. check that all events on the paths e.g. is an event that is not NIGHT mode, and is not preceded by NIGHT mode
        ...
        // P__7_insert_more_here
        }
    }) 
  }
}
check P__7
// P__7:cap_state_attr_home,cap_state_attr_home_val_false,cap_location_attr_mode,null
// P__7:^,cap_presenceSensor_attr_presence,null
// P__7:^,cap_presenceSensor_attr_presence,null
// P__7_insert_metadata_here
...
assert P__8 {
  ...
  no r : IoTApp.rules, action : r.commands {
    ...
    // e.g. check that all events on the paths e.g. is an event that is not NIGHT mode, and is not preceded by NIGHT mode
        ...
        // P__8_insert_more_here
        }
    }) 
  }
}
check P__8
// P__8:cap_state_attr_runIn,cap_state_attr_runIn_val_on,cap_presenceSensor_attr_presence,null
// P__8_insert_metadata_here

assert P__9 {
  // there is no situation where C occurs (e.g. the switch is automatically off)
  no r : IoTApp.rules, action : r.commands {
    action.attribute = cap_location_attr_mode
    action.value     = app_BonVoyage.newMode
    (some predecessor : r.*(~connected), action' : predecessor.triggers, cond: predecessor.conditions {
    // caused by some path of events
    // that does not have X (e.g. NIGHT mode)
    // e.g. check that all events on the paths e.g. is an event that is not NIGHT mode, and is not preceded by NIGHT mode
        ...
        {
            action'.attribute = cap_state_attr_runIn
            (no action'.value and cond.attribute = action'.attribute and cond.value = cap_state_attr_runIn_val_on) or action'.value     = cap_state_attr_runIn_val_on
        ...
        // P__9_insert_more_here
        }
    }) 
  }
}
check P__9
// P__9:cap_location_attr_mode,app_BonVoyage.newMode,cap_state_attr_runIn,cap_state_attr_runIn_val_on
// P__9:^,cap_presenceSensor_attr_presence,null
// P__9:^,cap_presenceSensor_attr_presence,null
// P__9:^,cap_presenceSensor_attr_presence,null
// P__9:^,cap_presenceSensor_attr_presence,null
// P__9_insert_metadata_here
