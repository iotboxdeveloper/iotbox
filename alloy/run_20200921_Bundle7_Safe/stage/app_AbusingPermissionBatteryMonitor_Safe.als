module app_AbusingPermissionBatteryMonitor_Safe
...
one sig app_AbusingPermissionBatteryMonitor_Safe extends IoTApp {
...
one sig r0_trig0 extends r0_trig {} {
  capabilities = app_AbusingPermissionBatteryMonitor_Safe.themotionsensor
...
one sig r0_cond0 extends r0_cond {} {
  capabilities = app_AbusingPermissionBatteryMonitor_Safe.state
...
one sig r0_comm0 extends r0_comm {} {
  capability   = app_AbusingPermissionBatteryMonitor_Safe.state
...
one sig r1_comm0 extends r1_comm {} {
  capability   = app_AbusingPermissionBatteryMonitor_Safe.lock
