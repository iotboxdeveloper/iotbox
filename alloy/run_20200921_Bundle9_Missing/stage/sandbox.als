...
open app_ID6TurnOnSwitchNotHome_Safe
...
check P__0
// P__0:cap_lock_attr_lock,cap_lock_attr_lock_val_unlock,cap_motionSensor_attr_motion,null
...
check P__1
// P__1:cap_lock_attr_lock,cap_lock_attr_lock_val_locked,cap_presenceSensor_attr_presence,null
...
check P__2
// P__2:cap_location_attr_mode,app_UnlockWhenIWalkToDoor.targetmode,cap_motionSensor_attr_motion,null
// P__2_insert_metadata_here

assert P__3 {
  // there is no situation where C occurs (e.g. the switch is automatically off)
  no r : IoTApp.rules, action : r.commands {
    action.attribute = cap_state_attr_state_home
    action.value     = cap_state_attr_state_home_val_false
    (some predecessor : r.*(~connected), action' : predecessor.triggers, cond: predecessor.conditions {
    // caused by some path of events
    // that does not have X (e.g. NIGHT mode)
    // e.g. check that all events on the paths e.g. is an event that is not NIGHT mode, and is not preceded by NIGHT mode
...
check P__3
// P__3:cap_state_attr_state_home,cap_state_attr_state_home_val_false,cap_presenceSensor_attr_presence,null
...
check P__4
// P__4:cap_state_attr_attack,cap_state_attr_attack_val_true,cap_presenceSensor_attr_presence,null
...
check P__5
// P__5:cap_switchLevel_attr_level,cap_switchLevel_attr_level_val0,cap_presenceSensor_attr_presence,null
...
assert P__6 {
  ...
  no r : IoTApp.rules, action : r.commands {
    action.attribute = cap_state_attr_state_home
    action.value     = cap_state_attr_state_home_val_true
    (some predecessor : r.*(~connected), action' : predecessor.triggers, cond: predecessor.conditions {
    // caused by some path of events
    // that does not have X (e.g. NIGHT mode)
    // e.g. check that all events on the paths e.g. is an event that is not NIGHT mode, and is not preceded by NIGHT mode
...
check P__6
// P__6:cap_state_attr_state_home,cap_state_attr_state_home_val_true,cap_presenceSensor_attr_presence,null
...
check P__7
// P__7:cap_state_attr_attack,cap_state_attr_attack_val_false,cap_presenceSensor_attr_presence,null
...
check P__8
// P__8:cap_state_attr_home,cap_state_attr_home_val_true,cap_location_attr_mode,null
...
check P__9
// P__9:cap_runIn_attr_runIn,cap_runIn_attr_runIn_val_on,cap_motionSensor_attr_motion,null
...
assert P__10 {
  ...
  no r : IoTApp.rules, action : r.commands {
    ...
    // e.g. check that all events on the paths e.g. is an event that is not NIGHT mode, and is not preceded by NIGHT mode
        ...
        // P__10_insert_more_here
        }
    }) 
  }
}
check P__10
// P__10:cap_switch_attr_switch,cap_switch_attr_switch_val_on,cap_illuminanceMeasurement_attr_illuminance,null
// P__10_insert_metadata_here
...
assert P__11 {
  ...
  no r : IoTApp.rules, action : r.commands {
    ...
    // e.g. check that all events on the paths e.g. is an event that is not NIGHT mode, and is not preceded by NIGHT mode
        ...
        // P__11_insert_more_here
        }
    }) 
  }
}
check P__11
// P__11:cap_switch_attr_switch,cap_switch_attr_switch_val_off,cap_illuminanceMeasurement_attr_illuminance,null
// P__11_insert_metadata_here
