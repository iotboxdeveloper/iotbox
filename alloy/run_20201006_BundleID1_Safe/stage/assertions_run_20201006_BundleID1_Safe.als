...
open app_DoorOpenWarningLight
open app_ID1BrightenMyPath_Safe
...
assert P__0 {
  ...
  no r : IoTApp.rules, action : r.commands {
    action.attribute = cap_state_attr_scheduled
    action.value     = cap_state_attr_scheduled_val_true
    ...
    // e.g. check that all events on the paths e.g. is an event that is not NIGHT mode, and is not preceded by NIGHT mode
        ...
        (
        {
            ...
            (no action'.value and cond.attribute = action'.attribute and cond.value = cap_lock_attr_lock_val_unlocked) or action'.value     = cap_lock_attr_lock_val_unlocked
...
check P__0
// P__0:cap_state_attr_scheduled,cap_state_attr_scheduled_val_true,cap_lock_attr_lock,cap_lock_attr_lock_val_unlocked
...
check P__1
// P__1:cap_state_attr_runIn,cap_state_attr_runIn_val_on,cap_lock_attr_lock,cap_lock_attr_lock_val_unlocked
...
check P__2
// P__2:cap_lock_attr_lock,cap_lock_attr_lock_val_locked,cap_state_attr_runIn,cap_state_attr_runIn_val_on
...
assert P__3 {
  ...
  no r : IoTApp.rules, action : r.commands {
    action.attribute = cap_state_attr_scheduled
    action.value     = cap_state_attr_scheduled_val_false
    (some predecessor : r.*(~connected), action' : predecessor.triggers, cond: predecessor.conditions {
    // caused by some path of events
    // that does not have X (e.g. NIGHT mode)
    // e.g. check that all events on the paths e.g. is an event that is not NIGHT mode, and is not preceded by NIGHT mode
...
check P__3
// P__3:cap_state_attr_scheduled,cap_state_attr_scheduled_val_false,cap_state_attr_runIn,cap_state_attr_runIn_val_on
...
check P__4
// P__4:cap_switch_attr_switch,cap_switch_attr_switch_val_on,cap_motionSensor_attr_motion,null
// P__4:^,cap_contactSensor_attr_contact,null
...
check P__5
// P__5:cap_switch_attr_switch,cap_switch_attr_switch_val_off,cap_contactSensor_attr_contact,null
// P__5:^,cap_motionSensor_attr_motion,null
// P__5_insert_metadata_here

assert P__6 {
  // there is no situation where C occurs (e.g. the switch is automatically off)
  no r : IoTApp.rules, action : r.commands {
    action.attribute = cap_state_attr_scheduledLightOn
    action.value     = cap_state_attr_scheduledLightOn_val_false
    (some predecessor : r.*(~connected), action' : predecessor.triggers, cond: predecessor.conditions {
    // caused by some path of events
    // that does not have X (e.g. NIGHT mode)
    // e.g. check that all events on the paths e.g. is an event that is not NIGHT mode, and is not preceded by NIGHT mode
...
check P__6
// P__6:cap_state_attr_scheduledLightOn,cap_state_attr_scheduledLightOn_val_false,cap_contactSensor_attr_contact,null
// P__6:^,cap_motionSensor_attr_motion,null
...
assert P__7 {
  ...
  no r : IoTApp.rules, action : r.commands {
    action.attribute = cap_state_attr_scheduledLightOn
    action.value     = cap_state_attr_scheduledLightOn_val_true
    (some predecessor : r.*(~connected), action' : predecessor.triggers, cond: predecessor.conditions {
    // caused by some path of events
    // that does not have X (e.g. NIGHT mode)
    // e.g. check that all events on the paths e.g. is an event that is not NIGHT mode, and is not preceded by NIGHT mode
...
check P__7
// P__7:cap_state_attr_scheduledLightOn,cap_state_attr_scheduledLightOn_val_true,cap_motionSensor_attr_motion,null
// P__7:^,cap_contactSensor_attr_contact,null
