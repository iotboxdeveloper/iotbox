...
check P__0
// P__0:cap_location_attr_mode,cap_location_attr_mode_val_Home,cap_motionSensor_attr_motion,cap_motionSensor_attr_motion_val_active
...
check P__1
// P__1:cap_switch_attr_switch,cap_switch_attr_switch_val_on,cap_motionSensor_attr_motion,cap_motionSensor_attr_motion_val_active
...
assert P__2 {
  ...
  no r : IoTApp.rules, action : r.commands {
    ...
    // e.g. check that all events on the paths e.g. is an event that is not NIGHT mode, and is not preceded by NIGHT mode
        ...
        (
        {
            action'.attribute = cap_app_attr_app
            (no action'.value and cond.attribute = action'.attribute and cond.value = cap_app_attr_app_val_appTouch) or action'.value     = cap_app_attr_app_val_appTouch
...
check P__2
// P__2:cap_lock_attr_lock,cap_lock_attr_lock_val_unlocked,cap_app_attr_app,cap_app_attr_app_val_appTouch
// P__2:^,cap_motionSensor_attr_motion,cap_motionSensor_attr_motion_val_active
// P__2:^,cap_switch_attr_switch,null
...
check P__3
// P__3:cap_location_attr_mode,cap_location_attr_mode_val_Away,cap_switch_attr_switch,null
