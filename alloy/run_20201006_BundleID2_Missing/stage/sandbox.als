...
open app_SecurityNightLight
open app_HumidityResetSchedule
open app_ID2SecuritySystem_Safe
...
assert P__0 {
  ...
  no r : IoTApp.rules, action : r.commands {
    action.attribute = cap_state_attr_motionStarted
    action.value     = cap_state_attr_motionStarted_val_false
...
check P__0
// P__0:cap_state_attr_motionStarted,cap_state_attr_motionStarted_val_false,cap_motionSensor_attr_motion,null
...
assert P__1 {
  ...
  no r : IoTApp.rules, action : r.commands {
    action.attribute = cap_state_attr_motionStarted
    action.value     = cap_state_attr_motionStarted_val_true
    (some predecessor : r.*(~connected), action' : predecessor.triggers, cond: predecessor.conditions {
    // caused by some path of events
    // that does not have X (e.g. NIGHT mode)
    // e.g. check that all events on the paths e.g. is an event that is not NIGHT mode, and is not preceded by NIGHT mode
...
check P__1
// P__1:cap_state_attr_motionStarted,cap_state_attr_motionStarted_val_true,cap_motionSensor_attr_motion,null
// P__1_insert_metadata_here

assert P__2 {
  // there is no situation where C occurs (e.g. the switch is automatically off)
  no r : IoTApp.rules, action : r.commands {
    action.attribute = cap_state_attr_thingsOn
    action.value     = cap_state_attr_thingsOn_val_true
    (some predecessor : r.*(~connected), action' : predecessor.triggers, cond: predecessor.conditions {
    // caused by some path of events
    // that does not have X (e.g. NIGHT mode)
    // e.g. check that all events on the paths e.g. is an event that is not NIGHT mode, and is not preceded by NIGHT mode
...
check P__2
// P__2:cap_state_attr_thingsOn,cap_state_attr_thingsOn_val_true,cap_motionSensor_attr_motion,null
...
check P__3
// P__3:cap_switch_attr_switch,cap_switch_attr_switch_val_on,cap_motionSensor_attr_motion,null
...
check P__4
// P__4:cap_lock_attr_lock,cap_lock_attr_lock_val_unlock,cap_presenceSensor_attr_presence,null
...
check P__5
// P__5:cap_state_attr_runIn,cap_state_attr_runIn_val_on,cap_presenceSensor_attr_presence,null
