module app_ID8_1LocationModeChangeFail_Safe
...
one sig app_ID8_1LocationModeChangeFail_Safe extends IoTApp {
...
one sig r0_trig0 extends r0_trig {} {
  capabilities = app_ID8_1LocationModeChangeFail_Safe.people
...
one sig r0_cond0 extends r0_cond {} {
  capabilities = app_ID8_1LocationModeChangeFail_Safe.location
  attribute    = cap_location_attr_mode
  value        = cap_location_attr_mode_val - app_ID8_1LocationModeChangeFail_Safe.newMode
}
...
one sig r0_comm0 extends r0_comm {} {
  capability   = app_ID8_1LocationModeChangeFail_Safe.state
...
one sig r1_cond0 extends r1_cond {} {
  capabilities = app_ID8_1LocationModeChangeFail_Safe.state
  attribute    = cap_state_attr_runIn
  value        = cap_state_attr_runIn_val_on
}
...
one sig r1_comm0 extends r1_comm {} {
  capability   = app_ID8_1LocationModeChangeFail_Safe.location
  attribute = cap_location_attr_mode
  value        = app_ID8_1LocationModeChangeFail_Safe.newMode
}
