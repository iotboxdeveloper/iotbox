...
open app_AwayModewithEcoTurnOff
open app_DoubleTapModeChange
open app_ID8_1LocationModeChangeFail_Safe
open app_SomeAtHome
...
check P__0
// P__0:cap_location_attr_mode,cap_location_attr_mode_val_Away,cap_presenceSensor_attr_presence,null
// P__0:^,cap_switch_attr_switch,null
// P__0:^,cap_switch_attr_switch,null
...
check P__1
// P__1:cap_switch_attr_switch,cap_switch_attr_switch_val_off,cap_presenceSensor_attr_presence,null
// P__1:^,cap_switch_attr_switch,null
...
check P__2
// P__2:cap_location_attr_mode,cap_location_attr_mode_val_Home,cap_switch_attr_switch,null
...
check P__3
// P__3:cap_state_attr_runIn,cap_state_attr_runIn_val_on,cap_presenceSensor_attr_presence,null
// P__3:^,cap_switch_attr_switch,null
...
assert P__4 {
  ...
  no r : IoTApp.rules, action : r.commands {
    action.attribute = cap_location_attr_mode
    action.value     = app_ID8_1LocationModeChangeFail_Safe.newMode
    (some predecessor : r.*(~connected), action' : predecessor.triggers, cond: predecessor.conditions {
    // caused by some path of events
    // that does not have X (e.g. NIGHT mode)
    // e.g. check that all events on the paths e.g. is an event that is not NIGHT mode, and is not preceded by NIGHT mode
...
check P__4
// P__4:cap_location_attr_mode,app_ID8_1LocationModeChangeFail_Safe.newMode,cap_state_attr_runIn,cap_state_attr_runIn_val_on
// P__4:^,cap_switch_attr_switch,null
...
check P__5
// P__5:cap_runIn_attr_runIn,cap_runIn_attr_runIn_val_on,cap_presenceSensor_attr_presence,null
// P__5:^,cap_switch_attr_switch,null
...
assert P__6 {
  ...
  no r : IoTApp.rules, action : r.commands {
    action.attribute = cap_location_attr_mode
    action.value     = app_SomeAtHome.newMode
    (some predecessor : r.*(~connected), action' : predecessor.triggers, cond: predecessor.conditions {
    // caused by some path of events
    // that does not have X (e.g. NIGHT mode)
    // e.g. check that all events on the paths e.g. is an event that is not NIGHT mode, and is not preceded by NIGHT mode
        ...
        {
            action'.attribute = cap_runIn_attr_runIn
            (no action'.value and cond.attribute = action'.attribute and cond.value = cap_runIn_attr_runIn_val_on) or action'.value     = cap_runIn_attr_runIn_val_on
...
check P__6
// P__6:cap_location_attr_mode,app_SomeAtHome.newMode,cap_runIn_attr_runIn,cap_runIn_attr_runIn_val_on
// P__6:^,cap_switch_attr_switch,null
// P__6:^,cap_presenceSensor_attr_presence,null
