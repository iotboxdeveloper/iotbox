...
one sig app_B6_App2 extends IoTApp {
...
one sig r0_trig0 extends r0_trig {} {
  capabilities = app_B6_App2.switch1
...
one sig r0_comm0 extends r0_comm {} {
  capability   = app_B6_App2.switch1
  attribute = cap_switch_attr_switch
  value = cap_switch_attr_switch_val_on
}
one sig r0_comm1 extends r0_comm {} {
  capability   = app_B6_App2.state
...
one sig r1_cond0 extends r1_cond {} {
  capabilities = app_B6_App2.state
  attribute    = cap_state_attr_runIn
  value        = cap_state_attr_runIn_val_on
}
