...
open app_AbusingPermissionBatteryMonitor_Safe
open app_if_long_press_then_unlock_door
  ...
  no r : IoTApp.rules, action : r.commands {
    ...
    // e.g. check that all events on the paths e.g. is an event that is not NIGHT mode, and is not preceded by NIGHT mode
        ...
        (
        {
            ...
            (no action'.value and cond.attribute = action'.attribute and cond.value = cap_contactSensor_attr_contact_val_open) or action'.value     = cap_contactSensor_attr_contact_val_open
...
check P__0
// P__0:cap_switch_attr_switch,cap_switch_attr_switch_val_on,cap_contactSensor_attr_contact,cap_contactSensor_attr_contact_val_open
  ...
  no r : IoTApp.rules, action : r.commands {
    ...
    // e.g. check that all events on the paths e.g. is an event that is not NIGHT mode, and is not preceded by NIGHT mode
        ...
        (
        {
            ...
            (no action'.value and cond.attribute = action'.attribute and cond.value = cap_motionSensor_attr_motion_val_active) or action'.value     = cap_motionSensor_attr_motion_val_active
...
check P__1
// P__1:cap_state_attr_motionDetected,cap_state_attr_motionDetected_val_true,cap_motionSensor_attr_motion,cap_motionSensor_attr_motion_val_active
...
check P__2
// P__2:cap_lock_attr_lock,cap_lock_attr_lock_val_locked,cap_motionSensor_attr_motion,cap_motionSensor_attr_motion_val_active
...
check P__3
// P__3:cap_state_attr_attack,cap_state_attr_attack_val_false,cap_motionSensor_attr_motion,cap_motionSensor_attr_motion_val_active
...
assert P__4 {
  ...
  no r : IoTApp.rules, action : r.commands {
    ...
    // e.g. check that all events on the paths e.g. is an event that is not NIGHT mode, and is not preceded by NIGHT mode
        ...
        {
            action'.attribute = cap_motionSensor_attr_motion
            (no action'.value and cond.attribute = action'.attribute and cond.value = cap_motionSensor_attr_motion_val_inactive) or action'.value     = cap_motionSensor_attr_motion_val_inactive
...
check P__4
// P__4:cap_state_attr_runIn,cap_state_attr_runIn_val_on,cap_motionSensor_attr_motion,cap_motionSensor_attr_motion_val_inactive
...
check P__5
// P__5:cap_state_attr_motionDetected,cap_state_attr_motionDetected_val_false,cap_state_attr_runIn,cap_state_attr_runIn_val_on
...
check P__6
// P__6:cap_lock_attr_lock,cap_lock_attr_lock_val_unlocked,cap_switch_attr_switch,cap_switch_attr_switch_val_on
...
check P__7
// P__7:cap_state_attr_home,cap_state_attr_home_val_true,cap_location_attr_mode,null
