module app_ID14LockDoorWhenHomeModeSet_Safe
...
one sig app_ID14LockDoorWhenHomeModeSet_Safe extends IoTApp {
...
one sig r0_trig0 extends r0_trig {} {
  capabilities = app_ID14LockDoorWhenHomeModeSet_Safe.location
...
one sig r0_comm0 extends r0_comm {} {
  capability   = app_ID14LockDoorWhenHomeModeSet_Safe.state
  attribute = cap_state_attr_home
  value = cap_state_attr_home_val_true
}
one sig r0_comm1 extends r0_comm {} {
  capability   = app_ID14LockDoorWhenHomeModeSet_Safe.lock
