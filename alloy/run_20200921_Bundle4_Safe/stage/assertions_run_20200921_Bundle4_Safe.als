...
check P__0
// P__0:cap_ovenMode_attr_ovenMode,cap_ovenMode_attr_ovenMode_val_grill,cap_location_attr_mode,null
...
check P__1
// P__1:cap_momentary_attr_momentary,cap_momentary_attr_momentary_val_push,cap_state_attr_runIn,cap_state_attr_runIn_val_on
  ...
  no r : IoTApp.rules, action : r.commands {
    ...
    // e.g. check that all events on the paths e.g. is an event that is not NIGHT mode, and is not preceded by NIGHT mode
        ...
        (
        {
            ...
            (no action'.value and cond.attribute = action'.attribute and cond.value = app_OpenDoorWhenSmokeDetected.detected) or action'.value     = app_OpenDoorWhenSmokeDetected.detected
...
check P__2
// P__2:cap_state_attr_runIn,cap_state_attr_runIn_val_on,cap_smokeDetector_attr_smoke,app_OpenDoorWhenSmokeDetected.detected
